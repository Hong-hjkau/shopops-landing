...
If you run a UK restaurant or takeaway, the delivery apps are probably your busiest "member of staff" — and your most expensive one. The headline commission rate is only part of the story. Once you add VAT, customer-side fees and the orders you'd have got anyway, the real cost of every delivery order is higher than most owners think.

This guide breaks down what Deliveroo, Uber Eats and Just Eat actually charge in 2026, shows what's left of a £10 dish after the apps take their cut, and explains the practical ways smaller restaurants are clawing some of that margin back.
...
> The uncomfortable truth: on the delivery apps you're often making more money for the platform than for your own kitchen.

## So should you ditch the apps?

No — and any guide that tells you to is being lazy. The platforms genuinely bring three things that are hard to replace overnight:
...
For a brand-new site with no following, that reach is worth paying for. The mistake isn't *using* the apps — it's letting them own your **repeat** customers, where you're paying 30% to deliver food to someone who already knows and likes you.
...
This is exactly the gap [ShopOps](/) is built for: it's an all-in-one ordering system for small UK restaurants — QR self-ordering at the table, a staff POS, and your own branded takeaway site — so the customers who already love you can order direct instead of through a 30% middleman. You still run the apps to find new faces; you just stop paying commission on the regulars.

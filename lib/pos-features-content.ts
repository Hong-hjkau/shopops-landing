  ...
  en: {
    ...
    workflow: {
      ...
      stories: [
        ...
        { title: "Collect payment and close the bill", body: "Staff take cash or card, apply discounts and close the bill from the unpaid list.", imageAlt: "English demo checkout screen showing the collect-payment window with cash and card options.", imageActionLabel: "Enlarge the collect-payment demo screen" },
      ],
    },
    core: {
  ...
  "zh-Hant": {
    ...
    workflow: {
      ...
      stories: [
        ...
        { title: "收款並完成結帳", body: "員工在未付款清單揀返張單，收現金或信用卡、套用折扣，完成結帳。", imageAlt: "英文示範結帳畫面，顯示收款視窗及現金、信用卡選項。", imageActionLabel: "放大收款示範畫面" },
      ],
    },
    core: {
      eyebrow: "核心 POS 已包括",
  ...
  "zh-Hans": {
    ...
    workflow: {
      ...
      stories: [
        ...
        { title: "收款并完成结账", body: "员工在未付款清单选回账单，收现金或银行卡、应用折扣，完成结账。", imageAlt: "英文演示结账画面，显示收款窗口及现金、银行卡选项。", imageActionLabel: "放大收款演示画面" },
      ],
    },
    core: {
      eyebrow: "核心 POS 已包括",

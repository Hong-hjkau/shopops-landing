...
三張產品卡：
- **ShopOps POS** — 餐廳點餐 / POS / 廚房看板 / 離線後備。✅ live → 撳入 `/pos`。
- **Reviewscope** — 餐廳評價監察。（對外文案待 HONG 最終確認）
- **Rota** — 員工排班 + 打卡出席。（對外文案待 HONG 最終確認）

> ⚠️ Reviewscope / Rota 對外成熟度由 HONG 拍板；卡可標「了解更多 → 聯絡」而唔一定要有獨立產品頁（首版可以淨係 POS 有頁，其餘導去 `#contact`）。
...
## 7. 開放項（實作前 HONG 拍板）
1. Reviewscope / Rota 對外文案（賣點一句）+ 首版係咪只導 `#contact`。
2. 公司頁 nav 第二項叫「服務」定「我哋做咩」。
3. 主 CTA 文字：「談你個項目」定「免費諮詢」。
